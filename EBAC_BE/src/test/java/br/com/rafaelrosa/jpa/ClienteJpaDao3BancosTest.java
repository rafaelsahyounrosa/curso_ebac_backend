...
import br.com.rafaelrosa.dao.jpa.ClienteJpaDB2DAO;
import br.com.rafaelrosa.dao.jpa.ClienteJpaDB3DAO;
...
public class ClienteJpaDao3BancosTest {
	...
	public void alterarCliente()
		...
		clienteConsultado.setNome("Rafael Rosa");
		clienteDao.alterar(clienteConsultado);

		ClienteJpa clienteAlterado = clienteDao.consultar(clienteConsultado.getId());
		Assert.assertNotNull(clienteAlterado);
		Assert.assertEquals("Rafael Rosa", clienteAlterado.getNome());
